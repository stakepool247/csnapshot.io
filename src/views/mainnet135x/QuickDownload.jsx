...
export default function QuickDownload() {
	return (
		<Box component='section' sx={{ mt: 5 }}>
			...
			<Terminal
				cmd='curl -o - https://downloads.csnapshots.io/mainnet-1-35-x/$(curl -s https://downloads.csnapshots.io/mainnet-1-35-x/mainnet-1-35-x-db-snapshot.json| jq -r .[].file_name ) | lz4 -c -d - | tar -x -C /home/cardano/cnode/'
