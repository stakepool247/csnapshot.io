...
export default function SupportUs() {
	return (
		<Box component='section' sx={{ mt: 5 }}>
			...
			<Terminal
				cmd='curl -o - https://downloads.csnapshots.io/snapshots/mainnet/$(curl -s https://downloads.csnapshots.io/snapshots/mainnet/mainnet-db-snapshot.json| jq -r .[].file_name ) | lz4 -c -d - | tar -x -C /home/cardano/cnode/'
